...
int main(){
    ...
    Shader cubeShader("cube_l03_05_03.vs", "cube_l03_05_03.fs");
    cubeShader.use();
    ...
    cubeShader.setFloat("lamp.cosCutOff",   glm::cos(glm::radians(12.5f)));
    ...
    Shader lampShader("lamp_l03_05_03.vs", "lamp_l03_05_03.fs");
    lampShader.use();
