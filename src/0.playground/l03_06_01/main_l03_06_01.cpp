...
int main(){
    ...
    Shader cubeShader("cube_l03_06_01.vs", "cube_l03_06_01.fs");
    cubeShader.use();
    glm::vec3 plampPos[] = {
    ...
    Shader dlampShader("dlamp_l03_06_01.vs", "dlamp_l03_06_01.fs");
    dlampShader.use();
    ...
    Shader plampShader("plamp_l03_06_01.vs", "plamp_l03_06_01.fs");
    plampShader.use();
